...
<div class="btn-group">
<a class="btn  dropdown-toggle" data-toggle="dropdown">校內表格 <span class="caret"></span></a>
...
<div class="btn-group">
<a class="btn  dropdown-toggle" data-toggle="dropdown">報部表格 <span class="caret"></span></a>
<ul class="dropdown-menu">
...
<div class="btn-group">
<a class="btn  dropdown-toggle" data-toggle="dropdown">遠距表格 <span class="caret"></span></a>
<ul class="dropdown-menu">
