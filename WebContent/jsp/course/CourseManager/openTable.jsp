...
<table class="table">
	<tr>
		<td>
		<select name="cidno" class="selectpicker" data-width="auto">
		...
		<select name="sidno" class="selectpicker" data-width="auto">
		...
		<select name="didno" class="selectpicker" data-width="auto">			
		...
		<select name="classes" class="selectpicker" data-width="auto">
